...
using VideoPlayerTrimmer.Resources;
using Xamarin.Forms;
...
namespace VideoPlayerTrimmer.Controls
{
    ...
    /// </summary>
    public partial class MyPlaybackControls : TemplatedView, IPlaybackControls
    {
        ...
        /// <summary>
        /// Initializes a new instance of <see cref="MyPlaybackControls"/> class.
        /// </summary>
        public MyPlaybackControls()
        {
            Resources.Add(new LibVLCSharp.Forms.Shared.Themes.Generic());
            Style = (Style)(Resources["PlaybackControlsStyle"]);
            ControlTemplate = (ControlTemplate)Style.Setters.FirstOrDefault(x=>x.Property.PropertyName == "ControlTemplate").Value;
        ...
        public static readonly BindableProperty AudioTracksSelectionButtonStyleProperty = BindableProperty.Create(
            nameof(AudioTracksSelectionButtonStyle), typeof(Style), typeof(MyPlaybackControls));
        /// <summary>
        ...
        public static readonly BindableProperty BufferingProgressBarStyleProperty = BindableProperty.Create(nameof(BufferingProgressBarStyle),
            typeof(Style), typeof(MyPlaybackControls));
        /// <summary>
        ...
        public static readonly BindableProperty ClosedCaptionsSelectionButtonStyleProperty = BindableProperty.Create(
            nameof(ClosedCaptionsSelectionButtonStyle), typeof(Style), typeof(MyPlaybackControls));
        /// <summary>
        ...
        public static readonly BindableProperty VideoViewProperty = BindableProperty.Create(nameof(VideoView), typeof(VideoView),
            typeof(MyPlaybackControls), propertyChanged: null);
        ...
        /// </summary>
        public static readonly BindableProperty LibVLCProperty = BindableProperty.Create(nameof(LibVLC), typeof(LibVLC), typeof(MyPlaybackControls),
        ...
        public static readonly BindableProperty KeepScreenOnProperty = BindableProperty.Create(nameof(KeepScreenOn), typeof(bool),
            typeof(MyPlaybackControls), true, propertyChanged: KeepScreenOnPropertyChanged);
        /// <summary>
        ...
        public static readonly BindableProperty ShowAndHideAutomaticallyProperty = BindableProperty.Create(nameof(ShowAndHideAutomatically),
            typeof(bool), typeof(MyPlaybackControls), true);
        /// <summary>
        ...
        public static readonly BindableProperty IsAudioTracksSelectionButtonVisibleProperty = BindableProperty.Create(
            nameof(IsAudioTracksSelectionButtonVisible), typeof(bool), typeof(MyPlaybackControls), true,
        ...
        public static readonly BindableProperty IsCastButtonVisibleProperty = BindableProperty.Create(nameof(IsCastButtonVisible), typeof(bool),
            typeof(MyPlaybackControls), true, propertyChanged: IsCastButtonVisiblePropertyChanged);
        /// <summary>
        ...
        public static readonly BindableProperty IsClosedCaptionsSelectionButtonVisibleProperty = BindableProperty.Create(
            nameof(IsClosedCaptionsSelectionButtonVisible), typeof(bool), typeof(MyPlaybackControls), true,
        ...
        public static readonly BindableProperty IsPlayPauseButtonVisibleProperty = BindableProperty.Create(nameof(IsPlayPauseButtonVisible),
            typeof(bool), typeof(MyPlaybackControls), true, propertyChanged: IsPlayPauseButtonVisiblePropertyChanged);
        /// <summary>
        ...
        public static readonly BindableProperty IsSeekEnabledProperty = BindableProperty.Create(nameof(IsSeekEnabled), typeof(bool),
            typeof(MyPlaybackControls), true);
        /// <summary>
        ...
        private static readonly BindableProperty EnableRendererDiscoveryProperty = BindableProperty.Create(nameof(EnableRendererDiscovery),
            typeof(bool), typeof(MyPlaybackControls), true, propertyChanged: EnableRendererDiscoveryPropertyChanged);
        ...
        {
            DebugLog("GestureRecognized: " + e.GetType().ToString());
            switch (e)
            {
                case TappedEventArgs tappedEventArgs:
                    if (ControlsPanel.Opacity == 1)
                    {
                        FadeOutTimer.Change(TimeSpan.FromMilliseconds(-1), TimeSpan.FromMilliseconds(-1));
                        FadeOut();
                    ...
                    break;
                case PanUpdatedEventArgs panEventArgs:
                    OnPanGesture(panEventArgs);
                    break;
                case PinchGestureUpdatedEventArgs pinchEventArgs:

                    break;
                case SwipedEventArgs swipeEventArgs:
                    break;
                default:
                    break;
            }
        ...
        private void OnPanGesture(PanUpdatedEventArgs panEventArgs)
        {
            DebugLog("PanEvent {0}-{1} {2}", panEventArgs.TotalX, panEventArgs.TotalY, panEventArgs.StatusType);
